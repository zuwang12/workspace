...
# + code_folding=[0, 4, 27, 51, 108, 117, 128]
class ReplayBuffer:
    ...
    with writer.as_default():
        while frame_number < TOTAL_FRAMES:
            ...
            while epoch_frame < FRAMES_BETWEEN_EVAL:
                ...
                for epi_length in range(MAX_EPISODE_LENGTH):
                    print('frame_number : {}, epoch_frame : {}, epi_length : {}'.format(frame_number, epoch_frame, epi_length))
                    # Get action
            ...
            for eval_length in range(EVAL_LENGTH):
                print('eval_length : {}'.format(eval_length))
                if terminal:
